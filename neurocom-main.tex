...
X_t^k = (\vec{0}, ..., x_t, ..., \vec{0}) \in \mathbb{R}^{K \times d}
\end{equation}
 a sequence of null vectors, except at position $k$ where the observation vector $x_t$ is found, so that $$\langle W, X^k\rangle = \langle w_k, x\rangle$$ 
