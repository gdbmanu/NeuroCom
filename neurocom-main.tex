...
We have shown that a conservative reduction of the OVA hinge-loss  provides an effective and lightweight solutions to the  bandit classification problem (defined by \cite{kakade2008efficient}). 
