...
\begin{theorem}
	...
	and let $U \in \mathbb{R}^{K\times d}$ be such that $ \forall t, l^*_t=0$. Then, the cumulative squared loss of algorithm \ref{algo:quad} is bounded by,
	\begin{equation}
