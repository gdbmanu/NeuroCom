...
One can distinguish two principal margin constraint schemes : the \emph{normative} and the \emph{relative} schemes.
\begin{itemize}
	\item in a \emph{normative} scheme (\emph{aka} one-vs-all), the classifier is expected to provide a normal response, i.e. $$\forall k,i \left\{
	\begin{array}{l}
