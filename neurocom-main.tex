...
\begin{table}[h]
	\caption{Parameters setting for different algorithms and different datasets.  {\bf P} stands for Perceptron, {\bf PA} for Passive Agressive, {\bf B} for Banditron, {\bf C} for Confidit, {\bf K-B} for the Kernel Banditron, {\bf K-Algo1} and {\bf K-Algo2} for the Kernel  realization of algorithms 1 and 2.}
	\label{table:bpa}
	%\begin{center}
	...
	\begin{center}
		\begin{tabular}{llllll}
			...
			&&&&& $C = 10^{-2}$\\
			\hline
			&{\bf K-B} & {\bf Algo1} & {\bf K-Algo1} &{\bf K-Algo2}\\
			\hline
...
We investigate on Figures \ref{pic:BPASNSerr} %et  \ref{pic:BPARCVerr}  
...
\begin{figure}[ht!]
	...
	\caption{Cumulative Errors on the synthetic data set of  SynSep, SynNonSep and RCV1-v2 (53 classes).}
	\label{pic:BPASS}
\end{figure}
