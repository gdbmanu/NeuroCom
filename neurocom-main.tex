...
In its original formulation ($C \rightarrow \infty$), this learning setup implements a "one-shot" update, i.e. carries out a zero-loss  after update. A finite stiffness parameter $C$ provides a more progressive update, allowing to deal more smoothly with outliers at the cost of a lesser sparsity.
