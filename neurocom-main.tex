...
It appears quite surprising the approach was not much considered up to now in the machine learning community. One possible reason is that it is not fitted to deal with label noise and adversarial, and does not implement UCB, and the convergence to correct classifier was not clearly established. The many advantages developped here should allow reconsider this point. 
