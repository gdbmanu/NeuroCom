...
The two last datasets are real-world datasets, having a smaller number of instances and a smaller dimension, allowing to test the algorithms performance and sparsity in the Kernel embedding case.   
...
In order to faithfully compare the methods, all parameters are obtained by cross-validation on the final classification rate. The resulting parameters, as they are used in simulations, are given in table \ref{table:bpa}. 
